...
//#define LED3_TOGGLE		OUTPUT_TOGGLE(PTG,PTG3)

#define LED0_OFF		OUTPUT_CLEAR(PTG,PTG0);
#define LED1_OFF		OUTPUT_CLEAR(PTG,PTG1);
#define LED2_OFF		OUTPUT_CLEAR(PTG,PTG2);
//#define LED3_OFF		OUTPUT_CLEAR(PTC,PTC3);


#define LED0_ON			OUTPUT_SET(PTG,PTG0);
#define LED1_ON			OUTPUT_SET(PTG,PTG1);
#define LED2_ON			OUTPUT_SET(PTG,PTG2);
